...
interface StatusBadgeProps {
  statusColorMap: Record<string, "green" | "yellow" | "red" | "gray" | "blue">;
  status: string;
}
...
const StatusBadge = ({ status, statusColorMap }: StatusBadgeProps) => {
  ...
  return (
    <span
      className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium ${badgeColorClasses[color]}`}
    >
